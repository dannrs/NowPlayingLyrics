...
export default function Artist({
  ...
  return (
    <Link
      ...
      target="_blank"
      href={url}
      className="flex items-center gap-5 p-4 overflow-hidden bg-gray-900 border-b border-l border-r border-gray-300 hover:bg-white dark:bg-darkPrimary hover:dark:bg-darkSecondary first:border-t dark:border-neutral-600 font-barlow"
    >
      <>
